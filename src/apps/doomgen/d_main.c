...
void D_DoomMain (void)
{
    ...
    int numiwadlumps;
#endif
    extern void bos_puts(const char*);
    bos_puts("[D_DoomMain] enter\n");
    ...
    bos_puts("[D_DoomMain] Z_Init\n");
    DEH_printf("Z_Init: Init zone memory allocation daemon. \n");
    Z_Init ();
    bos_puts("[D_DoomMain] Z_Init done\n");
    ...
    bos_puts("[D_DoomMain] W_Init\n");
    DEH_printf("W_Init: Init WADfiles.\n");
    D_AddFile(iwadfile);
    bos_puts("[D_DoomMain] W_Init done\n");
#if ORIGCODE
...
//    W_PrintDirectory();
    ...
    bos_puts("[D_DoomMain] M_Init\n");
    DEH_printf("M_Init: Init miscellaneous info.\n");
    M_Init ();

    bos_puts("[D_DoomMain] R_Init\n");
    DEH_printf("R_Init: Init DOOM refresh daemon - ");
    R_Init ();
    bos_puts("[D_DoomMain] R_Init done\n");

    DEH_printf("\nP_Init: Init Playloop state.\n");
    P_Init ();
    bos_puts("[D_DoomMain] P_Init done\n");

    DEH_printf("S_Init: Setting up sound.\n");
    S_Init (sfxVolume * 8, musicVolume * 8);
    bos_puts("[D_DoomMain] S_Init done\n");
    ...
    ST_Init ();
    bos_puts("[D_DoomMain] ST_Init done -> entering D_DoomLoop\n");
