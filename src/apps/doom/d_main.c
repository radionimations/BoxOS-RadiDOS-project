...
// wipe update
    ...
    do
    {
        do
        {
            extern void __BoxOS_AdvanceTicCount(void);
            __BoxOS_AdvanceTicCount();   /* keep ticcount in sync */
...
{
    /* BoxOS port: don't auto-advance to demo playback. Without a
     * functioning renderer the demo loops just freeze on a non-E1M1
     * level, confusing the user. Stay on the title forever until the
     * user explicitly picks a menu option. */
