/* 8x8 ASCII font (printable, 32..126). One byte per row, MSB=leftmost.
 * Hand-coded so the kernel has no external font dependency. */
...
const unsigned char font_8x8[96][8] = {
    ...
    { 0x64, 0x68, 0x10, 0x20, 0x4c, 0x8c, 0x00, 0x00 },  /* '%' */
    { 0x30, 0x48, 0x30, 0x68, 0x94, 0x88, 0x74, 0x00 },  /* '&' */
    ...
    { 0x78, 0x08, 0x10, 0x08, 0x04, 0x44, 0x38, 0x00 },  /* '3' */
    { 0x10, 0x30, 0x50, 0x90, 0xfc, 0x10, 0x10, 0x00 },  /* '4' */
    ...
    /* lowercase: alias to caps shapes */
    { 0x38, 0x44, 0x44, 0x7c, 0x44, 0x44, 0x44, 0x00 },  /* 'a' */
    { 0x78, 0x44, 0x44, 0x78, 0x44, 0x44, 0x78, 0x00 },  /* 'b' */
    { 0x38, 0x44, 0x40, 0x40, 0x40, 0x44, 0x38, 0x00 },  /* 'c' */
    { 0x78, 0x44, 0x44, 0x44, 0x44, 0x44, 0x78, 0x00 },  /* 'd' */
